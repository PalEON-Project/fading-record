...
ab_lut  <- as.data.frame(matrix(NA, nrow = length(fia_plots), ncol= 5))
colnames(ab_lut) <- c("plt_cn","dbh", "dens", "ab", "invyr")
...
save(ab_lut, file = "../../data/ab_lut_yr.Rdata")
